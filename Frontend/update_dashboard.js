...
// Replace the Report Issue button section
const targetContent = `<div className="z-10 flex gap-4">
                    <Button 
                        variant="secondary" 
...
const replacement = `<div className="z-10 flex flex-col gap-2 relative mt-4 md:mt-0">
                    ...
                    {emergencyStatus && (
                        <p className="text-white text-sm font-medium absolute -bottom-6 w-full whitespace-nowrap drop-shadow-sm flex items-center">
                            {emergencyStatus}
                        </p>
                    )}
                </div>`;
