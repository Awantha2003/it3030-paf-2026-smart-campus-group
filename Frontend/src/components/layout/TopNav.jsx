        ...
        <>
            ...
            <div className="flex items-center gap-4">
                ...
                >
                    ...
                    {unreadCount > 0 && (
                        <span className="absolute top-0 right-0 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-red-500 px-1 text-[10px] font-bold text-white border border-white dark:border-brand-surface">
